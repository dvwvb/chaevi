<!DOCTYPE html>
<html lang="ko" class="fullpage-html">

<head>
    <meta charset="utf-8" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <title>채비 l 전기차 충전 원스탑 솔루션</title>
    <meta name="Title" content="채비 l 전기차 충전 원스탑 솔루션" />
    <meta name="Subject" content="채비 l 전기차 충전 원스탑 솔루션" />
    ...
    <meta property="og:title" content="채비 l 전기차 충전 원스탑 솔루션" />
    ...
    <meta name="twitter:title" content="채비 l 전기차 충전 원스탑 솔루션" />
    ...
    <link rel="stylesheet" type="text/css" href="../../unpkg.com/swiper%408.4.2/swiper-bundle.min.css" />
...
<body>
    ...
    <div id="wrap" class="index-wrapper">
        ...
        <div id="fullpage">
            ...
            <section id="mainVisual" class="section white-ver">
                <header id="header" class="top-fixed-object white-ver">
                    ...
                    <div id="headerInnerWrap">
                        ...
                        <div id="headerInner" class="area-wrap-box">
                            <h1 class="logo">
                                <a href="index-2.html" title="to home"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 505.64 58.34">
                                        <defs>
                                            <style>
                                                .logo-1 {
                                                    fill: #6cc4d5;
                        ...
                        <nav id="gnb" class="total-menu">
                            ...
                            <ul class="clearfix">
                                <li class="gnb1">
                                    <a href="company/brand_story.html"><em class="en">CHAEVI</em></a>
                                    <div class="gnb-2dep">
                                        <ul>
                                            <li>
                                                <a href="company/brand_story.html"><span>채비 브랜드 소개</span></a>
                                            </li>
                                            <li>
                                                <a href="company/price.html"><span>채비 요금제</span></a>
                                            </li>
                                            <li>
                                                <a href="company/app.html"><span>채비 APP</span></a>
                                            </li>
                                            <li>
                                                <a href="company/zone.html"><span>채비스테이</span></a>
                                            </li>
                                            <li>
                                                <a href="company/station.html"><span>메가스테이션</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                ...
                <div class="area-box">
                    <article class="main-app-container">
                        <div class="main-tit-box scroll-object" data-scroll="fade-up">
                            ...
                            <h3 class="main-sm-tit cm-word-split-JS" data-splitting data-css-property="transition" data-speed="0.03" data-speed-delay="0">
                                충전은 채비 앱으로!
                            </h3>
                            <p class="main-sub-txt">
                                간편한 사용 조작으로 보다 편리하게 <br />주위 충전기를 찾아
                                충전하세요
                            </p>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_01f490.jpg?ver=220718" alt="app capture image 1" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_02f490.jpg?ver=220718" alt="app capture image 2" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_03f490.jpg?ver=220718" alt="app capture image 3" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_04f490.jpg?ver=220718" alt="app capture image 4" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_05f490.jpg?ver=220718" alt="app capture image 5" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_06f490.jpg?ver=220718" alt="app capture image 6" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_08f490.jpg?ver=220718" alt="app capture image 8" />
                                        </div>
                                    </div>
                                    <div class="swiper-slide app-slide">
                                        <div class="app-item-thumb">
                                            <img src="../images/content/app_capture_09f490.jpg?ver=220718" alt="app capture image 9" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="area-box">
                    <div class="main-charge-container">
                        <div class="main-tit-box scroll-object" data-scroll="fade-up">
                            ...
                            <h3 class="main-sm-tit cm-word-split-JS" data-splitting data-css-property="transition" data-speed="0.03" data-speed-delay="0">
                                국내 최저가 충전 <br class="m-br" />요금으로
                                <br class="pc-br" />채비하세요.
                            </h3>
                        ...
                        <article class="charge-compare-con" data-scroll>
                            <div class="charge-compre-item cheavi-member-con">
                                <h4 class="charege-compare-tit">
                                    <em>CHAEVI MEMBER</em><b>채비 회원</b>
                                </h4>
                            ...
                            <div class="charge-compre-item third-party-member-con">
                                <h4 class="charege-compare-tit">
                                    <em>THIRD-PARTY MEMBER</em><b>타사 회원</b>
                                </h4>
                                <div class="charge-compare-detail">
                                    <dl>
                                        <dt>100kW급 이상 급속</dt>
                            ...
                            <p class="main-charge-plus-txt">
                                * 위탁운영 충전기는 별도 요금이 적용될수 있습니다.
                            </p>
                        </article>
                    </div>
                </div>
            ...
            <section id="mainChaevizoneCon" class="section">
                ...
                <div class="area-box main-chaevizone-container">
                    <div class="main-tit-box white-ver" data-scroll="fade-up">
                        <h3 class="main-tit">
                            <img src="../images/main/main_chaevizone_titfbf2.png?ver='555'" alt="CHAEVI zone" />
                        </h3>
                        <p class="main-sub-txt2">
                            채비스테이는 기존 충전을 위한 공간에서 다양한
                            <br class="m-br" />서비스를 제공하며,<br class="pc-br" />입지와
                            상권에 맞춘 다양한 <br class="m-br" />복합문화 공간을
                            제공합니다.
                        </p>
            ...
            <section id="mainMegaStationCon" class="section">
                ...
                <div class="area-box">
                    <div class="main-mega-container">
                        <div class="main-tit-box white-ver" data-scroll="fade-up">
                            <h3 class="main-big-tit cm-word-split-JS" data-splitting data-css-property="transition" data-speed="0.03" data-speed-delay="0">
                                <b class="en">Mega Station</b>
                            </h3>
                            <p class="main-sub-txt2">
                                고객과의 관계 지속형 Localization을 통하여
                                <br class="m-br" />머무르는 공간으로 지속적 고객과
                                <br class="pc-br" />Contact를 <br class="m-br" />통한 사업의
                                연속성을 제공합니다.
                            </p>
			...
			<div class="cm-section-bg" data-scroll><div class="cm-section-bg-inner"></div></div>
			<div class="area-box">
                            ...
                            <ul class="news-list-con clearfix">
                                <li class="news-item">
                                    <a href="customer/news0dc9.html?bgu=view&amp;idx=52" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">한국타이어, 전기차 전용 '아이온' 론칭 기념
                                                프로모션</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsf422.html?bgu=view&amp;idx=49" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">전기차 충전 브랜드 ‘채비’, 홍보관 열고 청년들과 열린
                                                소통 나선다</span>
                                        </h3>
                                        <span class="news-date">2022.09.15</span>
                                    </a>
                                ...
                                <li class="news-item">
                                    <a href="customer/newseaf9.html?bgu=view&amp;idx=48" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">채비, 추석 연휴 기간 ‘한가위에도 타임 투 채비’ 고객
                                                감사 이벤트 진행</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/news59d2.html?bgu=view&amp;idx=43" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">올해 울산 학교 107곳에 전기차 완속충전시설 143기
                                                구축한다</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsa703.html?bgu=view&amp;idx=42" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">청년과미래, '새로운 미래' 위한 2022 대한민국 청년의
                                                날 축제 개최</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/news33e1.html?bgu=view&amp;idx=40" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">진천군·대영채비(주), 전기차 충전인프라 투자 양해각서
                                                체결</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/news83e5.html?bgu=view&amp;idx=36" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">채비, ‘전기차 충전인프라 산업전’ 참가…초고속 충전기
                                                등 소개</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsdfcf.html?bgu=view&amp;idx=24" class="news-item-inner">
                                        ...
                                        <p class="news-sub-txt line-clamp3">
                                            [헤럴드경제(경주)=김병진 기자]경북 경주시는 4일 시청에서
                                            전기차 충전기 보급관리업체인 채비와 전기차 충전 인프라
                                            구축 민간투자사업 업무협약을 체결했다.이번 협약에 따라
                                            채비는&nbsp;2024년&nbsp;12월까지&nbsp;150억원을 들여
                                            공영주차장 등에 전기차 급속 충전시설&nbsp;200기 이상을
                                            보급한다.이 회사는 충전요금 가운데 일부를 한국전력에
                                            납부하고 나머지를 수익금으로 가져간다.시는 법령 허용
                                            범위에서 행정 사항을 적극 지원하며 양 기관은
                                            충전료를&nbsp;2030년까지 환경부 고시 금액보다&nbsp;10%
                                            이상 할인한 금액을 적용하기로 약정했다.이에 따라
                                            현재&nbsp;85개소&nbsp;139기에 머무는 경주지역 전기차
                                            급속 충전시설이 개선될 전망이다.경주시는 정부의
                                            탄소중립&nbsp;2050프로젝트를 선도적으로 이행하기 위해
                                            기초자치단체 최초로 민간투자사업을 추진하기로
                                            했다.정민교 채비 대표는 “경주시와의 파트너쉽을 확장해
                                            나가겠다"며 "전기차를 기반으로 한 미래형자동차 선도도시
                                            구축을 위해 대영채비는 신기술 개발에 더욱더 박차를 가할
                                            것”이라고 밝혔다.주낙영 경주시장은 “전기차 충전사업이
                                            본격적인 민간 주도 사업으로 전환하는 계기를 마련하는
                                            이번 협약으로 경주를 중심으로 친환경차 관련 산업
                                            생태계가 조성돼 지역 경제 활성화에 기여할 수 있을 것으로
                                            기대한다”고 말했다.* 기사
                                            원본&nbsp;https://n.news.naver.com/mnews/article/016/0002011362?sid=102
                                        </p>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsd21a.html?bgu=view&amp;idx=23" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">국내 넘어 전세계 전기차 충전기 시장 제패 꿈꾼다…
                                                채비</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/news9042.html?bgu=view&amp;idx=22" class="news-item-inner">
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">도로교통공단, 채비 손잡고 '전기차 충전기' 241대
                                                구축</span>
                                        </h3>
                                        <p class="news-sub-txt line-clamp3">
                                            [미디어펜=김상준 기자]도로교통공단과 전기차 충전기
                                            보급관리 업체 대영채비(주)가 업무협약을 맺고 전기차 충전
                                            인프라를 확대한다.&nbsp;17일 도로교통공단은 채비와
                                            ‘전기차 충전 인프라 구축 민간투자사업 업무협약’을
                                            체결했다고 밝혔다.이번 협약은 정부의 탄소중립
                                            2050프로젝트를 선도적으로 이행하기 위한 것으로, 공공기관
                                            최초로 민간투자사업을 추진하여 대규모(241대) 전기차 충전
                                            인프라를 구축하는 내용을 담고 있다.협약에 따라 양 기관은
                                            올해 하반기 내에 도로교통공단 52개 조직에 전기차
                                            충전소를 설치할 예정이다.공단은 이를 통해 전기차를
                                            이용하는 공단 방문객 및 인근 지역주민의 전기차 충전에
                                            대한 불편 해소에 도움이 될 것으로 보고 있다.채비는 연간
                                            1만 대 이상의 전기차 충전기를 보급하고 관리·운영하는
                                            민간 충전솔루션 업체로 이번 도로교통공단 사업을 시작으로
                                            공공기관에 전기차 충전기를 선도적으로 보급할 계획을
                                            갖고있다.도로교통공단 관계자는 “전기차 충전 인프라
                                            구축으로 친환경차 보급 확산의 기반을 조성하고 저탄소
                                            녹색성장의 기반을 마련할 수 있을 것으로 기대한다”며
                                            “공단은 다양한 ESG 경영 활동으로 공공기관으로서 사회적
                                            책무를 완수하는 데 최선을 다하겠다”라고 말했다.* 기사
                                            원본&nbsp;http://www.mediapen.com/news/view/731751
                                        </p>
                                ...
                                <li class="news-item">
                                    <a href="customer/news9f0a.html?bgu=view&amp;idx=7" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">채비, 미쓰이 그룹과 일본시장 진출 위한 업무협약
                                                맺어</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsf27b.html?bgu=view&amp;idx=6" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">대구시, 채비‧E3모밀리티… 무공해차 전환 브랜드사업
                                                선정</span>
                                        </h3>
                                ...
                                <li class="news-item">
                                    <a href="customer/newsf470.html?bgu=view&amp;idx=5" class="news-item-inner">
                                        ...
                                        <h3 class="news-tit line-clamp2">
                                            <span class="news-tit-inner">채비, 비마이카와 '친환경 e모빌리티 서비스 활성화'
                                                업무협약</span>
                                        </h3>
                    ...
                    <div id="footerInner" class="area-box">
                        ...
                        <article id="footerTop">
                            <div class="clearfix">
                                ...
                                <div class="footer-left-con">
                                    <p class="footer-slogan-txt">
                                        Let's start the <br class="m-br" />future
                                        <br class="pc-br" />of mobility
                                        <br class="m-br" />together
                                    </p>
                                    <div class="footer-address">
                                        ...
                                        <div class="footer-address-txt">
                                            ...
                                            <p>팩스 : 053-584-1512</p>
                                            <p>
                                                <a href="mailto:dy@chaevi.co.kr">이메일 : dy@chaevi.co.kr</a>
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="footer-menu-sns-con">
                                        <ul class="foot-menu clearfix">
                                            <li>
                                                <a href="etc/privacy.html" class="cm-modal-open-btn">개인정보처리방침</a>
                                            </li>
                                        </ul>
                                        <div class="foot-sns-menu">
                                            <ul class="clearfix">
                                                <li>
                                                    <a href="https://www.instagram.com/chaevi_official" target="_blank" title="새창으로열기"><i class="xi-instagram"></i></a>
                                                </li>
                                                <li>
                                                    <a href="https://blog.naver.com/chaevibrand" target="_blank" title="새창으로열기"><i class="xi-naver"></i></a>
                                                </li>
                                                <li>
                                                    <a href="https://www.youtube.com/channel/UCF6cyJkPc2FykdqYNQDEr1A/featured" target="_blank" title="새창으로열기"><i class="xi-youtube-play"></i></a>
                                                </li>
                                        ...
                                        <ul class="footer-contact-list">
                                            ...
                                            <li>
                                                <dl>
                                                    <dt>미국 법인</dt>
                                                    <dd>
                                                        3003 North First Street #233, San Jose, California
                                                        95134
                                                    </dd>
                                                </dl>
                                            </li>
                        ...
                        <article id="footerBottom">
                            ...
                            <div class="footer-copyright">
                                Copyright &copy; 2022 All rights reserved | Daeyoung Chaevi
                            </div>
                        </article>
                    </div>
                </footer>
    ...
    <script type="text/javascript" src="../../unpkg.com/swiper%408.4.2/swiper-bundle.min.js"></script>
