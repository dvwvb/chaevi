							...
							<div class="area-box">
								<div class="station-slide-wrap">
									<div class="left-box" data-scroll="fade-up">
										...
										<p class="txt02">채비의 급속 충전기는 AC 급속, 차데모, DC 콤보 총 3개의 인터페이스를 제공해, <br
												class="pc-br" />국내차량은 물론 해외 차량까지 폭넓게 호환 가능합니다.</p>
									</div>

									<div class="right-box" data-scroll="fade-left">
										<ul class="station-slick-box">
											<li class="station-product-img"><span><img
														src="../../images/content/station_product_img01.png"
														alt=""></span></li>
											<li class="station-product-img"><span><img
														src="../../images/content/station_product_img02.png"
														alt=""></span></li>
											<li class="station-product-img"><span><img
														src="../../images/content/station_product_img03.png"
														alt=""></span></li>
										</ul>
									</div>
								</div>
